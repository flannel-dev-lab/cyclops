...
func Put(url string, headers map[string]string, queryParams map[string]string, requestBody map[string]string) (response *http.Response, err error) {
	data, err := json.Marshal(requestBody)
	if err != nil {
		return nil, err
	}
...
func Patch(url string, headers map[string]string, queryParams map[string]string, requestBody map[string]string) (response *http.Response, err error) {
	data, err := json.Marshal(requestBody)
	if err != nil {
		return nil, err
	}
